...
#if (defined ENABLE_RUNTIME_MEASUREMENTS) || (defined SYS_TICK_RUNTIME_MEASUREMENTS)
extern void SysDal_Rtm_EventHandler(void);
#endif /* (defined ENABLE_RUNTIME_MEASUREMENTS) || (defined SYS_TICK_RUNTIME_MEASUREMENTS) */
