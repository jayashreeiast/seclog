...
#define COMDAL_NFC_AR_RELEASE_MINOR_VERSION_C        4
#define COMDAL_NFC_AR_RELEASE_REVISION_VERSION_C     0

#define COMDAL_NFC_SW_MAJOR_VERSION_C                24
#define COMDAL_NFC_SW_MINOR_VERSION_C                12
#define COMDAL_NFC_SW_PATCH_VERSION_C                0
...
@details    For each NFC channel, this function shall:
            ...
            - when polling mode is used, cyclicly check if message was transmited succesfully by calling Can_Main_Write
            - when polling mode is used, cyclicly check if a new RX message was received succesfully by calling Can_Main_Read
...
/*=================================================================================================================================*/
/**
@brief      ComDal_Nfc_WriteData - function used to send data via NFC. Actual sending is done in Comdal_Nfc_Main, this function is
