...
#ifdef HSE_SPT_DICE
    #define HSE_SRV_DICE_GEN_KEY_PAIR           ((hseSrvId_t)(HSE_SRV_VER_0 | 0x00000110UL))  /**< @brief Generate DICE UDS/CDI0/CDIn key pair. Data structure used: #hseDiceGenerateKeyPairSrv_t. */
    #define HSE_SRV_DICE_GEN_SECRET             ((hseSrvId_t)(HSE_SRV_VER_0 | 0x00000111UL))  /**< @brief Generate DICE CDI0/CDIn secrets. Data structure used: #hseDiceGenerateSecretSrv_t. */
    #define HSE_SRV_DICE_GEN_SIGN_CERT          ((hseSrvId_t)(HSE_SRV_VER_0 | 0x00000112UL))  /**< @brief Generate the CDI0_PUB certificate or sign the CDIn_PUB (n>0) certificates. Data structure used: #hseDiceGenSignCertSrv_t. */
#endif
...
typedef struct
{
    ...
    union
    {
        ...
        #ifdef HSE_SPT_DICE
            hseDiceGenerateKeyPairSrv_t      diceKeyPairReq;        /**< @brief Request to generate DICE UDS/CDI0/CDIn key pair. */
            hseDiceGenerateSecretSrv_t       diceSecretReq;         /**< @brief Request to generate DICE CDI0/CDIn secret. */
            hseDiceGenSignCertSrv_t          diceGenSignCertReq;    /**< @brief Request to generate the CDI0_PUB certificate or sign the CDIn_PUB (n>0) certificates. */
        #endif
        ...
        /*--------DICE services--------*/
        #ifdef HSE_SPT_DICE
            hseDiceGenerateKeyPairSrv_t     diceGenerateKeyPairReq; /**< @brief Request to generate DICE key pairs*/
            hseDiceGenerateSecretSrv_t      diceGenerateSecretReq;  /**< @brief Request to generate DICE secrets*/
            hseDiceGenSignCertSrv_t         diceGenSignCert;        /**< @brief Request to sign a DICE certificate*/
        #endif
        /*-------- HSE CUSTOM SERVICE --------*/
        #if HSE_FWTYPE >= 8U
            HSE_CUSTOM_SERVICES
