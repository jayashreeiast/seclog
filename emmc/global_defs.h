...
#if defined(HSE_H)
    #define MAX_HSE_FW_IMG_SIZE                    (434176UL) //424KB
#else
    #define MAX_HSE_FW_IMG_SIZE                    (335872UL) //328KB
#endif
...
#if (defined(HSE_S32G2XX) && (HSE_S32G2XX == HSE_PLATFORM)) || \
    (defined(HSE_S32G3XX) && (HSE_S32G3XX == HSE_PLATFORM))

    #define HSE_FW_PINK_IMAGE_HEADER_SIZE           (4432UL) /* RSA2K */
#else
    #define HSE_FW_PINK_IMAGE_HEADER_SIZE           (6608UL) /* RSA3k */
#endif
...
/* CUST keys */    \
/* 0 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,  HSE_KEY_TYPE_SHE,           8U,        HSE_KEY128_BITS,  {0U} }, /* MASTER_ECU_KEY, BOOT_MAC_KEY, KEY_1 to KEY_10 */ \
/* 1 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_AES,           8U,        HSE_KEY128_BITS,  {0U} }, \
/* 2 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_AES,           8U,         HSE_KEY256_BITS,  {0U} }, \
              /* HMAC key */ \
/* 3 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_HMAC,          4U,         HSE_KEY1024_BITS, {0U} }, \
              /* ECC keys */ \
/* 4 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PAIR,      2U,         HSE_KEY521_BITS,  {0U} }, \
/* 5 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PUB,       3U,         HSE_KEY521_BITS,  {0U} }, \
/* 6 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PUB_EXT,   4U,         HSE_KEY521_BITS,  {0U} }, \
               /* RSA keys */ \
/* 7 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_RSA_PAIR,      2U,         HSE_KEY4096_BITS, {0U} }, \
/* 8 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_RSA_PUB,       3U,         HSE_KEY4096_BITS, {0U} }, \
/* 9 */       { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_RSA_PUB_EXT,   5U,         HSE_KEY4096_BITS, {0U} }, \
/* OEM keys */    \
/* 10 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_AES,            8U,        HSE_KEY128_BITS,  {0U} }, \
/* 11 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_AES,            8U,        HSE_KEY256_BITS,  {0U} }, \
              /* HMAC key */ \
/* 12 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_HMAC,           4U,         HSE_KEY1024_BITS, {0U} }, \
              /* ECC keys */ \
/* 13 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_ECC_PAIR,       2U,         HSE_KEY521_BITS,  {0U} }, \
/* 14 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_ECC_PUB,        3U,         HSE_KEY521_BITS,  {0U} }, \
/* 15 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_ECC_PUB_EXT,    5U,         HSE_KEY521_BITS,  {0U} }, \
              /* RSA keys */ \
/* 16 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_RSA_PAIR,       2U,         HSE_KEY4096_BITS, {0U} }, \
/* 17 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_RSA_PUB,        3U,         HSE_KEY4096_BITS, {0U} }, \
/* 18 */      { HSE_ALL_MU_MASK, HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_RSA_PUB_EXT,    2U,         HSE_KEY4096_BITS, {0U} }, \
/* 19 */      { HSE_MU0_MASK,    HSE_KEY_OWNER_OEM, HSE_KEY_TYPE_ECC_PUB,        1U,         HSE_KEY521_BITS,  {0U} }, \
/* 20 */      { 0U,              0U,                0U,                          0U,         0U,               {0U} }
...
#define  HSE_RAM_KEY_CATALOG_CFG  \
        ...
        /* ECC keys */\
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_ANY,   HSE_KEY_TYPE_ECC_PAIR,       4U,         HSE_KEY521_BITS,  {0U} }, \
...
#define NVM_IEE_DDR_AES128_KEY                  GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 1, 6)
#define NVM_AES256_KEY0                         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 2, 0)


/* OPEN DICE ECC PUB KEY */
#ifdef HSE_SPT_DICE
#define NVM_SMR_ECC256_PUB_KEY                  GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 5, 0)
#define NVM_ECC_SIGN_OEM_PUB_KEY                GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 14, 1)
#define NVM_ECC_VERIFY_OEM_PUB_KEY              GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 14, 2)
#define NVM_OPEN_DICE_ECC_PAIR_KEY0_UDS         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 4, 1)

#define RAM_OPEN_DICE_ECC_PAIR_KEY_CDI0         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 4, 0)
#define RAM_OPEN_DICE_ECC_PAIR_KEY_CDI1         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 4, 1)
#define RAM_OPEN_DICE_ECC_PAIR_KEY_CDI2         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 4, 2)
#define RAM_OPEN_DICE_ECC_PUB_KEY               GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 5, 1)

#define RAM_OPEN_DICE_AES256_KEY0               GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 2, 2)
#define RAM_OPEN_DICE_AES256_KEY1               GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 2, 3)
#endif
...
#define NVM_ECC_PUB_KEY_HANDLE_SLOT1            GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 5, 1)
#define NVM_ECC_PUB_KEY_HANDLE_SLOT2            GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 5, 2)
/* Must be in NVM */
...
/* CUST keys */    \
        ...
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_AES,           8U,         HSE_KEY128_BITS,  {0U} }, \
        /* HMAC key */ \
        ...
        { HSE_ALL_MU_MASK, HSE_KEY_OWNER_CUST, HSE_KEY_TYPE_ECC_PUB,       3U,         HSE_KEY256_BITS,  {0U} }, \
        /* RSA keys */ \
...
#define  HSE_RAM_KEY_CATALOG_CFG  \
        ...
        /* Usable only on MU0 */ \
        { HSE_MU0_MASK,    HSE_KEY_OWNER_ANY,   HSE_KEY_TYPE_AES,            3U,        HSE_KEY256_BITS,  {0U} }, \
        /* HMAC key */ \
...
#define NVM_OTFAD_AES128_KEY                    GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 1, 3)
#define NVM_IEE_DDR_AES128_KEY                  GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 1, 6)
#define NVM_AES256_KEY0                         GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 7, 0)
/* Key used for encrypted SMR authentication */
#define NVM_ENCRYPTED_SMR_AUTH_KEY_HANDLE       GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 1, 4)
/* Key used for encrypted SMR decrypt */
#define NVM_ENCRYPTED_SMR_DECRYPT_KEY_HANDLE    GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 1, 5)
...
#define NVM_ECC_PUB_KEY_HANDLE_SLOT1            GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 4, 1)
#define NVM_ECC_PUB_KEY_HANDLE_SLOT2            GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_NVM, 4, 2)
...
#error "Unkown HSE FW type"
...
#if (defined(HSE_S32ZE) && (HSE_S32ZE == HSE_PLATFORM))
    ...
    #define RAM_AES256_MSC_KEY3                 GET_KEY_HANDLE(HSE_KEY_CATALOG_ID_RAM, 2, 2)
