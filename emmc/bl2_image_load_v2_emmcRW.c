...
#define TEST_SECTOR   60686336  /* pick something far away from FIP */
#define BLOCK_SIZE    512

/* =======================================================================
 * eMMC Read/Write Test (ADDED)
 * ======================================================================= */
void bl2_emmc_test(void)
{
    ...
    /* ===== WRITE ===== */
    ret = mmc_write_blocks(TEST_SECTOR, (uintptr_t)write_buf, 512);
    if (ret != 512) {
    ...
    /* ===== READ ===== */
    ret = mmc_read_blocks(TEST_SECTOR, (uintptr_t)read_buf, 512);
    if (ret != 512) {
...
restart_from_head:
	...
	/* =======================================================================
	 * INSERTED HERE: Run eMMC read/write test BEFORE handoff
	 * ======================================================================= */
